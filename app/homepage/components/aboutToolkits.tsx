        ...
        <div className="container mx-auto grid items-center relative">
            ...
            <div className="fancy-feature-toolkit pt-20 pb-20">
                ...
                <Tabs defaultValue="howuse" className="w-full">
                    <TabsList >
                        <TabsTrigger value="howuse" className=" bg-[#2c7ebe] nav-link w-full h-full text-[22px] capitalize leading-[1.41em] text-white m-0 rounded-none border-b-[5px] border-b-transparent border-0 border-solid lg:text-[17px] lg:p-[30px_60px] md:text-[17px] md:p-[15px_30px] sm:text-[17px] sm:p-[22px_15px] xsm:text-[17px] xsm:p-[22px_15px] before:h-3 before:w-3 before:origin-bottom-left before:rotate-45 before:transform before:border before:border-neutral-500 before:bg-neutral-100 before:content-['']">
                            ...
                            {/* <div className="h-3 w-3 origin-bottom-left rotate-45 transform border border-neutral-500 bg-neutral-100"></div> */}
                        </TabsTrigger>
